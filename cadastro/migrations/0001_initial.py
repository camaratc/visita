# Generated by Django 2.1.2 on 2018-10-18 17:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataCadastro', models.DateTimeField(default=datetime.datetime(2018, 10, 18, 17, 2, 0, 787122), verbose_name='Data de Cadastro')),
            ],
            options={
                'ordering': ['nome'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data', models.DateField(default=datetime.datetime(2018, 10, 18, 17, 2, 0, 788124), verbose_name='Data')),
